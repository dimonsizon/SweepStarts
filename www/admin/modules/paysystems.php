...
<tr>
	<td style="color: #999999;"><b>PerfectMoney</b> [USD]<br />Курс: 1:<?php print $row['percent']; ?></td>
	<td width="20"><a href="?p=ps_edit&id=1"><img src="images/edit.png" width="24" height="24" border="0" alt="Редактировать" /></a></td>
	<td width="20"><img src="images/no_delite.png" width="24" height="24" border="0" alt="Удалить" /></td></tr>
<tr>
	<td colspan="3" height="1" bgcolor="#cccccc"></td>
</tr>
<tr>
	<td style="color: #999999;"><b>PAYEER.com</b> [<?php print cfgSET('cfgMonCur'); ?>]<br />Курс: 1:1</td>
	<td width="20"><img src="images/no_edit.png" width="24" height="24" border="0" alt="Редактировать" /></td>
	<td width="20"><img src="images/no_delite.png" width="24" height="24" border="0" alt="Удалить" /></td></tr>
<tr>
	<td colspan="3" height="1" bgcolor="#cccccc"></td>
</tr>
...
print "<tr>
	...
	<td width=\"20\"><a href=\"?p=ps_edit&id=".$row['id']."\"><img src=\"images/edit.png\" width=\"24\" height=\"24\" border=\"0\" alt=\"Редактировать\" /></a></td><td width=\"20\"><a onclick=\"if(confirm('Вы действительно хотите удалить данную платежную систему?')) top.location.href='del/ps.php?id=".$row['id']."';\"><img style=\"cursor: pointer;\" src=\"images/delite.png\" width=\"24\" height=\"24\" border=\"0\" alt=\"Удалить\" /></a></td></tr>
<tr>
	<td colspan=\"3\" height=\"1\" bgcolor=\"#cccccc\"></td>
</tr>";
}
