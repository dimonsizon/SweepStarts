...
<script type="text/javascript">
	tinyMCE.init({
		...
		<textarea id="elm1" style="width: 612px; background-color: #ffffff;" name="body" cols="80" rows="20"><?php print $body; ?></textarea>
		</td>
	</tr>
	<?php
	}
	...
	<tr>
		<td colspan="2" align="center">
		<textarea id="elm2" style="width: 612px; background-color: #ffffff;" name="body_en" cols="80" rows="20"><?php print $body_en; ?></textarea>
		</td>
	</tr>
	<?php
	}
